...
namespace EditorUI {
    ...
    class CutsceneSequencerPanel; // Forward declaration
    ...
    public:
        ...
        bool m_ShowCutsceneSequencer = false; // Toggle
        ...
        std::unique_ptr<CutsceneSequencerPanel> m_CutsceneSequencer; // New Panel
